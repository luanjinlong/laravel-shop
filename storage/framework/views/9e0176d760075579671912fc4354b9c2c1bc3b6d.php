                ...
                <div class="col-sm-9 col-md-7">
                  <select class="form-control" name="address">
                    <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($address->id, false); ?>"><?php echo e($address->full_address, false); ?> <?php echo e($address->contact_name, false); ?> <?php echo e($address->contact_phone, false); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
              </div>
  ...
  <script>
    $(document).ready(function () {
      ...
      $('.btn-create-order').click(function () {
        ...
        axios.post('<?php echo e(route('orders.store'), false); ?>', req)
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/laravel/resources/views/cart/index.blade.php ENDPATH**/ ?>